...
export const STATIC_BUNDLES: Record<"MTN" | "TELECEL" | "AIRTELTIGO", DataBundle[]> = {
  MTN: [
    make("MTN", "mtn-1gb",  "1GB",  4.50),
    make("MTN", "mtn-2gb",  "2GB",  9.30),
    make("MTN", "mtn-3gb",  "3GB",  13.80),
    make("MTN", "mtn-4gb",  "4GB",  18.80),
    make("MTN", "mtn-5gb",  "5GB",  23.50),
    make("MTN", "mtn-6gb",  "6GB",  27.40),
    make("MTN", "mtn-8gb",  "8GB",  35.70),
    make("MTN", "mtn-10gb", "10GB", 42.90),
    make("MTN", "mtn-15gb", "15GB", 62.00),
  ...
  AIRTELTIGO: ([
    ...
    make("AIRTELTIGO", "at-5gb",  "5GB",  23.50),
    make("AIRTELTIGO", "at-6gb",  "6GB",  25.00),
    make("AIRTELTIGO", "at-8gb",  "8GB",  35.50),
    make("AIRTELTIGO", "at-10gb", "10GB", 44.00),
